 ...
 * @author mirji507
 */
@WebFilter(filterName = "AuthorisationFilter", urlPatterns = {"/restricted/*"})
public class AuthorisationFilter implements Filter {
   ...
   private void doBeforeProcessing(ServletRequest request, ServletResponse response)
      ...
      if (debug) {
         log("AuthorisationFilter:DoBeforeProcessing");
      }
   ...
   private void doAfterProcessing(ServletRequest request, ServletResponse response)
           throws IOException, ServletException {
      if (debug) {
         log("AuthorisationFilter:DoAfterProcessing");
      }
   ...
   public void doFilter(ServletRequest request, ServletResponse response,
           FilterChain chain)
           throws IOException, ServletException {
      //cast the request and response objects into something useful
   ...
   public void init(FilterConfig filterConfig) {      
      ...
      if (filterConfig != null) {
         if (debug) {            
            log("AuthorisationFilter:Initializing filter");
         }
      }
   }
   ...
   public String toString() {
      if (filterConfig == null) {
         return ("AuthorisationFilter()");
      }
      StringBuffer sb = new StringBuffer("AuthorisationFilter(");
